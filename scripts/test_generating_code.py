...
suitesparse_list = ["mat_elemmul", "mat_identity", "matmul_ijk", "matmul_ikj", "matmul_jki", "matmul_jik", "matmul_kij",
                    "matmul_jki", "mat_vecmul_ij", "mat_vecmul_ji", "matmul_kji", "mat_elemadd3", "mat_sddmm.gv", "mat_elemadd",
                    "mat_mattransmul", "mat_residual", "mat_sddmm"]
vec_list = ["vec_elemadd", "vec_elemmul", "vec_scalar_mul", "mat_vecmul_ij", "mat_vecmul_ji", "vec_identity", "vec_scalar_mul"]
