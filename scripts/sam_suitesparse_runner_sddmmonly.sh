...
# LANKA
if [ $2 -eq 1 ]; then
	export SUITESPARSE_PATH=/data/scratch/strange/tamu_sparse_unpacked
...
#			SUITESPARSE_TENSOR_PATH=$matrix python $basedir/scripts/datastructure_suitesparse.py -n $line --o 
#
