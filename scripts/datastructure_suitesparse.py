...
def write_datastructure_bench(args, tensor, out_path, tiles=None):
    ...
    if "matmul_ijk" in args.benchname:
        ...
        formatWriter.writeout_separate_sparse_only(trans_shifted, dirname, tensorname, format_str="ss10", hw=args.onyx)
        ...
        tensorname = "C"
        trans_shifted = shifted.transpose()
        formatWriter.writeout_separate_sparse_only(trans_shifted, dirname, tensorname, format_str="ss01", hw=args.onyx)
    elif "mat_elemadd3" in args.benchname:
        print("Writing " + args.name + " shifted...")
        tensorname = "C"
        shifted = ScipyTensorShifter().shiftLastMode(coo)
        formatWriter.writeout_separate_sparse_only(shifted, dirname, tensorname, format_str="ss01", hw=args.onyx)

        print("Writing " + args.name + " shifted2...")
        tensorname = "D"
        shifted2 = ScipyTensorShifter().shiftLastMode(shifted2)
        formatWriter.writeout_separate_sparse_only(shifted2, dirname, tensorname, format_str="ss01", hw=args.onyx)
