...
#define FOREACH_FROSTT_TENSOR(__func__) \
  __func__(rand_tensor1, "rand_tensor1.tns") \
  __func__(rand_tensor2, "rand_tensor2.tns") \
  __func__(rand_tensor3, "rand_tensor3.tns") \
  __func__(rand_tensor4, "rand_tensor4.tns") \
  __func__(rand_tensor5, "rand_tensor5.tns") \
  __func__(rand_tensor6, "rand_tensor6.tns") \
  __func__(rand_tensor7, "rand_tensor7.tns") \
  __func__(rand_tensor8, "rand_tensor8.tns") \
  __func__(rand_tensor9, "rand_tensor9.tns") \
  __func__(rand_tensor10, "rand_tensor10.tns") \
  __func__(rand_tensor11, "rand_tensor11.tns") \
  __func__(rand_tensor12, "rand_tensor12.tns") \
  __func__(rand_tensor13, "rand_tensor13.tns") \
  __func__(rand_tensor14, "rand_tensor14.tns") \
  __func__(rand_tensor15, "rand_tensor15.tns") \
  __func__(rand_tensor16, "rand_tensor16.tns") \
  __func__(rand_tensor17, "rand_tensor17.tns") \
  __func__(rand_tensor18, "rand_tensor18.tns") \
  __func__(rand_tensor19, "rand_tensor19.tns") \
  __func__(rand_tensor20, "rand_tensor20.tns") \
  __func__(rand_tensor21, "rand_tensor21.tns") \
  __func__(rand_tensor22, "rand_tensor22.tns") \
  __func__(rand_tensor23, "rand_tensor23.tns") \
  __func__(rand_tensor24, "rand_tensor24.tns") \
  __func__(rand_tensor25, "rand_tensor25.tns") \
  __func__(rand_tensor26, "rand_tensor26.tns") \
  __func__(rand_tensor27, "rand_tensor27.tns") \
  __func__(rand_tensor28, "rand_tensor28.tns") \
  __func__(rand_tensor29, "rand_tensor29.tns") \
  __func__(rand_tensor30, "rand_tensor30.tns") \
  __func__(rand_tensor30, "rand_tensor30.tns") \
  __func__(rand_tensor32, "rand_tensor32.tns") \
  __func__(rand_tensor33, "rand_tensor33.tns") \
  __func__(rand_tensor34, "rand_tensor34.tns") \
  __func__(rand_tensor35, "rand_tensor35.tns") \
  __func__(rand_tensor36, "rand_tensor36.tns") \
  __func__(rand_tensor37, "rand_tensor37.tns") \
  __func__(rand_tensor38, "rand_tensor38.tns") \
  __func__(rand_tensor39, "rand_tensor39.tns") \
  __func__(rand_tensor40, "rand_tensor40.tns") \
  __func__(rand_tensor41, "rand_tensor41.tns") \
  __func__(rand_tensor42, "rand_tensor42.tns") \
  __func__(rand_tensor43, "rand_tensor43.tns") \
  __func__(rand_tensor44, "rand_tensor44.tns") \
  __func__(rand_tensor45, "rand_tensor45.tns") \
  __func__(rand_tensor46, "rand_tensor46.tns") \
  __func__(rand_tensor47, "rand_tensor47.tns") \
  __func__(rand_tensor48, "rand_tensor48.tns") \
  __func__(rand_tensor49, "rand_tensor49.tns") \
  __func__(rand_tensor50, "rand_tensor50.tns") \
