...
def test_tensor3_linear_add(samBench, frosttname, cast, check_gold, debug_sim, report_stats, fill=0):
    ...
    fiberlookup_Bj_12 = CompressedCrdRdScan(crd_arr=B_crd1, seg_arr=B_seg1, debug=debug_sim, statistics=report_stats)
    ...
    fiberlookup_Cj_13 = CompressedCrdRdScan(crd_arr=C_crd0, seg_arr=C_seg0, debug=debug_sim, statistics=report_stats)
    unionj_11 = Union2(debug=debug_sim, statistics=report_stats)
    ...
    while not done and time_cnt < TIMEOUT:
        ...
        fiberlookup_Bj_12.set_in_ref(fiberlookup_Bi_17.out_ref())
        ...
        unionj_11.set_in1(fiberlookup_Cj_13.out_ref(), fiberlookup_Cj_13.out_crd())
        unionj_11.set_in2(fiberlookup_Bj_12.out_ref(), fiberlookup_Bj_12.out_crd())
        fiberwrite_X1_2.set_input(unionj_11.out_crd())
        fiberlookup_Bk_10.set_in_ref(unionj_11.out_ref2())
        arrayvals_B_5.set_load(fiberlookup_Bk_10.out_ref())
        fiberwrite_X2_1.set_input(fiberlookup_Bk_10.out_crd())
        repsiggen_k_8.set_istream(fiberlookup_Bk_10.out_crd())
        repeat_Ck_7.set_in_ref(unionj_11.out_ref1())
    ...
    if check_gold:
        print("Checking gold...")
        check_gold_tensor3_linear_add(frosttname, debug_sim, cast, out_crds, out_segs, out_vals, "sss012")
