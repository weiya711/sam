...
arrs_dict2 = {'crd1_in': [0, 1, 'S0', 2, 3, 'S0', 'S0', 4, 5, 'S0', 'S1', 'D'],
              'crd2_in': [1, 2, 3, 'S0', 'S0', 0, 1, 2, 'S0', 'S0', 'S1', 'D'],
              'ref1_in': [0, 1, 'S0', 2, 3, 'S0', 'S0', 4, 5, 'S0', 'S1', 'D'],
              'ref2_in': [0, 1, 2, 'S0', 'S0', 2, 3, 4, 'S0', 'S0', 'S1', 'D'],
              'crd_gold': [0, 1, 2, 3, 'S0', 2, 3, 'S0', 0, 1, 2, 'S0', 4, 5, 'S0', 'S1', 'D'],
              'ref1_gold': [0, 1, 'N', 'N', 'S0', 2, 3, 'S0', 'N', 'N', 'N', 'S0', 4, 5, 'S0', 'S1', 'D'],
              'ref2_gold': ['N', 0, 1, 2, 'S0', 'N', 'N', 'S0', 2, 3, 4, 'S0', 'N', 'N', 'S0', 'S1', 'D']}
