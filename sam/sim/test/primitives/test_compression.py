...
def test_compress_1d(dim1, debug_sim):
    ...
    comp = Compression(debug=debug_sim)
    ...
    while not done and time < TIMEOUT:
        ...
        # in_val.append(in1.pop(0))
        # in_crd.append(crd.pop(0))
        # print("in_val", remove_emptystr(in_val))
        # print("in_crd", remove_emptystr(in_crd))

        comp.update()
        out_val.append(comp.out_val())
        out_crd.append(comp.out_crd())

        print("out_val", remove_emptystr(out_val))
        print("out_crd", remove_emptystr(out_crd))
