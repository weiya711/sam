...
arr_dict = {"seg": [0, 3, 5, 8, 10], "crd": [1, 3, 4, 1, 2, 0, 4, 5, 3, 5], "in_ref": [0, 1, 2, 3, 'S0', 'D'], "in_crd": [0, 1, 4, 6, 'S0', 'D'],
...
def test_reorder_direct(arrs, debug_sim):
    ...
    while not done and time < TIMEOUT:
        ...
        print(crd_k.done, ref_k.done, crd_i.done, ref_i.done, crd_k_out.done, ref_k_out.done)
