...
from sam.sim.src.accumulator_helpers import SpAcc1NoCrdHold, SpAcc2NoCrdHold
...
def test_spacc1_no_crdhold_direct(arrs, debug_sim):
    ...
    sa = SpAcc1NoCrdHold(val_stkn=True, debug=debug_sim)
...
def test_spacc2_no_crdhold_direct(arrs, debug_sim):
    ...
    sa = SpAcc2NoCrdHold(val_stkn=True, debug=debug_sim)
