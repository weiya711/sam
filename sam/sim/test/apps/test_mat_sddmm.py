...
def test_mat_sddmm(samBench, ssname, check_gold, debug_sim, report_stats, fill=0):
    ...
    fiberlookup_Ci_26 = UncompressCrdRdScan(dim=C_shape[0], debug=debug_sim, statistics=report_stats)
    ...
    fiberlookup_Dj_20 = UncompressCrdRdScan(dim=D_shape[1], debug=debug_sim, statistics=report_stats)
    intersectj_18 = Intersect2(debug=debug_sim, statistics=report_stats)
