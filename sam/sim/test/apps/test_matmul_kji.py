...
def test_matmul_kji_i(ssname, debug_sim, fill=0):
    ...
    while not done and time < TIMEOUT:
        ...
        spaccumulator2_3.crd_in-0-i(fiberlookup_Bi_10.out_ref())
        spaccumulator2_3.val(mul_4.out_ref())
        spaccumulator2_3.crd_in-1-j(fiberlookup_Cj_14.out_ref())
        spaccumulator2_3.update()

        fiberwrite_Xvals_0.set_input(spaccumulator2_3.out_val())
        fiberwrite_Xvals_0.update()

        fiberwrite_X0_1.set_input(spaccumulator2_3.out_crd_out-0())
        fiberwrite_X0_1.update()

        fiberwrite_X1_2.set_input(spaccumulator2_3.out_crd_out-1())
