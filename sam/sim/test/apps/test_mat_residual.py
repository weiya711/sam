...
def test_mat_residual(samBench, ssname, check_gold, debug_sim, report_stats, fill=0):
    ...
    repeat_di_13 = Repeat(debug=debug_sim, statistics=report_stats)
    ...
    for k in sample_dict.keys():
        extra_info["fiberlookup_dj_12" + "_" + k] = sample_dict[k]
    ...
    for k in sample_dict.keys():
        extra_info["fiberlookup_Ci_18" + "_" + k] = sample_dict[k]
