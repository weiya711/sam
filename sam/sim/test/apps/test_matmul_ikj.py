...
def test_matmul_ikj_i(ssname, debug_sim, fill=0):
    ...
    test_gold_matmul_ikj(ssname , formats = [orig, shift-trans],  out_crds = [fiberwrite_X0_2.get_arr(), fiberwrite_X1_1.get_arr()], out_segs = [fiberwrite_X0_2.get_seg_arr(), fiberwrite_X1_1.get_seg_arr()], out_vals = fiberwrite_Xvals_0.get_arr())
