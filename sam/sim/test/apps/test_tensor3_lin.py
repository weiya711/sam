...
@pytest.mark.frostt
def test_tensor3_lin(samBench, frosttname, check_gold, debug_sim, report_stats, fill=0):
    ...
    if check_gold:
        print("Checking gold...")
        check_gold_tensor3_lin(frosttname, debug_sim, out_crds, out_segs, out_vals, "sss012")
