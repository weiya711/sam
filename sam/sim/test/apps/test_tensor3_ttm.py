...
@pytest.mark.frostt
def test_tensor3_ttm(samBench, frosttname, check_gold, debug_sim, report_stats, fill=0):
    ...
    repeat_Ci_19 = Repeat(debug=debug_sim, statistics=report_stats)
    ...
    for k in sample_dict.keys():
        extra_info["fiberlookup_Bi_22" + "_" + k] = sample_dict[k]
