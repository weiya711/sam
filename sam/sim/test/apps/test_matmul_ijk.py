...
def test_matmul_ijk(ssname, debug_sim, fill = 0):
    ...
    fiberlookup_Cj_13 = UncompressRdScan( dim = C_shape[0], debug = debug_sim) 
    ...
    fiberwrite_X1_5 = CompressWrScan(seg_size = B_shape[0] + 1, size=B_shape[0] * C_shape[0], fill = fill, debug = debug_sim)
    fiberlookup_Ck_9  = CompressedRdScan(crd_arr=C_crd1, seg_arr=C_seg1, debug=debug_sim)
