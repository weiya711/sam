...
@pytest.mark.frostt
def test_tensor3_ttv(samBench, frosttname, check_gold, debug_sim, report_stats, fill=0):
    ...
    c_dirname = os.path.join(formatted_dir, frosttname, "other", "s0")
    ...
    repeat_cj_10 = Repeat(debug=debug_sim, statistics=report_stats)
