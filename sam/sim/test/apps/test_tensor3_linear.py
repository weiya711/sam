...
@pytest.mark.frostt
def test_tensor3_linear(samBench, frosttname, check_gold, debug_sim, report_stats, fill=0):
    ...
    D_dirname = os.path.join(formatted_dir, frosttname, "other", "d0")
    ...
    if check_gold:
        print("Checking gold...")
        check_gold_tensor3_linear(frosttname, debug_sim, out_crds, out_segs, out_vals, "sss021")
