...
def test_tensor4_multiply2(samBench, frosttname, cast, check_gold, debug_sim, report_stats, fill=0):
    ...
    fiberlookup_Cj_18 = CompressedCrdRdScan(crd_arr=C_crd2, seg_arr=C_seg2, debug=debug_sim, statistics=report_stats)
    ...
    fiberlookup_Cm_15 = CompressedCrdRdScan(crd_arr=C_crd3, seg_arr=C_seg3, debug=debug_sim, statistics=report_stats)
    fiberlookup_Cl_11 = CompressedCrdRdScan(crd_arr=C_crd1, seg_arr=C_seg1, debug=debug_sim, statistics=report_stats)
