...
def test_matmul_kij(samBench, ssname, check_gold, debug_sim, report_stats, fill=0):
    ...
    while not done and time_cnt < TIMEOUT:
        ...
        spaccumulator2_3_drop_crd.set_in_stream(intersectk_16.out_crd())
        ...
        spaccumulator2_3.set_crd(spaccumulator2_3_drop_crd.out_val())
        ...
        mul_5.update()
        spaccumulator2_3_drop_crd.update()
    ...
    for k in sample_dict.keys():
        extra_info["fiberlookup_Bk_17" + "_" + k] = sample_dict[k]
    ...
    for k in sample_dict.keys():
        extra_info["fiberlookup_Bi_15" + "_" + k] = sample_dict[k]
    ...
    for k in sample_dict.keys():
        extra_info["fiberlookup_Cj_11" + "_" + k] = sample_dict[k]
    ...
    for k in sample_dict.keys():
        extra_info["fiberlookup_Ck_18" + "_" + k] = sample_dict[k]
