...
def test_matmul_kij(samBench, ssname, debug_sim, fill=0):
    ...
    while not done and time_cnt < TIMEOUT:
        ...
        spaccumulator2_3_drop_crd_in_1.set_in_stream(fiberlookup_Bi_14.out_crd())
        spaccumulator2_3_drop_crd_in_0.set_in_stream(fiberlookup_Cj_10.out_crd())
        ...
        fiberwrite_X1_1.set_input(spaccumulator2_3.out_crd_0())
        fiberwrite_X1_1.update()

        fiberwrite_X0_2.set_input(spaccumulator2_3.out_crd_1())
    ...
    sample_dict = repeat_Ci_11.return_statistics()
    for k in sample_dict.keys():
        extra_info["repeat_Ci_11" + "_" + k] =  sample_dict[k]
