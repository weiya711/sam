...
@pytest.mark.frostt
def test_matmul_FINAL(samBench, frosttname, check_gold, report_stats, debug_sim, fill=0):
    ...
    C_dirname = os.path.join(formatted_dir, frosttname, "orig", "ss01")
    ...
    Bs_dirname = os.path.join(formatted_dir, frosttname, "orig", "sss012")
