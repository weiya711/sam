...
def test_tensor4_multiply(samBench, frosttname, check_gold, debug_sim, report_stats, fill=0):
    ...
    fiberlookup_Bk_20 = CompressedCrdRdScan(crd_arr=B_crd2, seg_arr=B_seg2, debug=debug_sim, statistics=report_stats)
    ...
    fiberlookup_Cl_16 = CompressedCrdRdScan(crd_arr=C_crd2, seg_arr=C_seg2, debug=debug_sim, statistics=report_stats)
