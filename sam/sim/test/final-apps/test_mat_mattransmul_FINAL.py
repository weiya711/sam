...
def test_mat_mattransmul_FINAL(samBench, ssname, cast, check_gold, report_stats, backpressure, depth, debug_sim, fill=0):
...
#    b_vals = read_inputs(e_vals_filename, float)
    ...
    arrayvals_e_10 = Array(init_arr=e_vals, debug=debug_sim, statistics=report_stats, back_en=backpressure, depth=int(depth))
    arrayvals_f_11 = Array(init_arr=f_vals, debug=debug_sim, statistics=report_stats, back_en=backpressure, depth=int(depth))
