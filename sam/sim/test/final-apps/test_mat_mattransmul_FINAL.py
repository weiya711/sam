...
def test_mat_mattransmul_FINAL(samBench, ssname, check_gold, debug_sim, fill=0):
    ...
    for k in sample_dict.keys():
        extra_info["repeat_ej_13" + "/" + k] = sample_dict[k]
    ...
    for k in sample_dict.keys():
        extra_info["repeat_fj_14" + "/" + k] = sample_dict[k]
