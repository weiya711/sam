...
def test_matmul_ikj(samBench, sparsity, check_gold, debug_sim, fill=0):
    ...
    repsiggen_i_17 = RepeatSigGen(debug=debug_sim)
    repeat_Ci_16 = Repeat(debug=debug_sim)
    ...
    repsiggen_j_10 = RepeatSigGen(debug=debug_sim)
    repeat_Bj_9 = Repeat(debug=debug_sim)
