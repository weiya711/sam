...
def test_mat_elemadd_FINAL(samBench, ssname, check_gold, report_stats, debug_sim, fill=0):
    ...
    B_crd0 = B_crd0_array[i_, k_]
    B_seg0 = B_seg0_array[i_, k_]
    C_crd0 = C_crd0_array[i_, k_]
    C_seg0 = C_seg0_array[i_, k_]

    B_crd1 = B_crd1_array[i_, k_]
    B_seg1 = B_seg1_array[i_, k_]
    C_crd1 = C_crd1_array[i_, k_]
    C_seg1 = C_seg1_array[i_, k_]
    
    B_vals = B_vals_array[i_, k_]
    C_vals = C_vals_array[i_, k_]
