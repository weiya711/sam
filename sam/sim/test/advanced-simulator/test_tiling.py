...
def test_tiling(samBench, ssname, check_gold, report_stats, debug_sim,
    ...
    while not done and time_cnt < TIMEOUT:
        ...
        time_cnt += 1
        if debug_sim:
            print("Timestep", time_cnt, max_cnt, " ", average / (average_len + 1), "\t k_out_crd:",
                  crdscan.out_crd_k_outer(), "\t k_out_ref:", crdscan.out_ref_k_outer(), "\t Crd i:",
                  crdscan.out_crd_i(), "\t Ref i:", crdscan.out_ref_i(), "\t Crd:",
