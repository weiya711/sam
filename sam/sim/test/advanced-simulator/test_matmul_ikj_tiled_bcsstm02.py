...
def test_matmul_ikj_tiled_bcsstm02(samBench, ssname, check_gold, debug_sim, report_stats, fill=0):
    ...
    struct = {"i00": 1 + int(math.sqrt(full_size)//(loop_config["Glb_tile_size"]*loop_config["Mem_tile_size"])), "k00": 1 + int(math.sqrt(full_size)//(loop_config["Glb_tile_size"]*loop_config["Mem_tile_size"])), "j00": 1 + int(math.sqrt(full_size)//(loop_config["Glb_tile_size"]*loop_config["Mem_tile_size"])), "i0": loop_config["Glb_tile_size"], "k0": loop_config["Glb_tile_size"], "j0": loop_config["Glb_tile_size"]}
    #print(memory_config)
    #print(loop_config)
    #print(struct)
    #return
    #struct = {"Bi00": 5, "Bk00": 5, "Ck00": 5, "Cj00": 5, "Bi0": 2, "Bk0": 2, "Ck0": 2, "Cj0": 2}
    ...
    #print(memory_config)
    glb_model_b = memory_block(name="GLB_B", size=memory_config["Glb_memory"], bandwidth=memory_config["Glb_tile_bandwidth"], latency=memory_config["Global_Glb_latency"])
    glb_model_c = memory_block(name="GLB_C", size=memory_config["Glb_memory"], bandwidth=memory_config["Glb_tile_bandwidth"], latency=memory_config["Global_Glb_latency"])

    mem_model_b = memory_block(name="B", size=memory_config["Mem_memory"], bandwidth=memory_config["Mem_tile_bandwidth"], latency=memory_config["Glb_Mem_latency"])
    mem_model_c = memory_block(name="C", size=memory_config["Mem_memory"], bandwidth=memory_config["Mem_tile_bandwidth"], latency=memory_config["Glb_Mem_latency"])
 
    mem_model_x = output_memory_block(name="X", level = "mem2glb") 
    glb_model_x = output_memory_block(name="X", level = "glb2global")
