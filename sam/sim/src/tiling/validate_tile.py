...
#                            C_tile_id = [j0, k0, j00, k00]
                            ...
                            B_tile_path = os.path.join(args.input_dir_path, "tensor_B_tile_" + "_".join(B_tile_id) + ".mtx")                                                 
                            C_tile_path = os.path.join(args.input_dir_path, "tensor_C_tile_" + "_".join(C_tile_id) + ".mtx")
